...
.. image:: /images/howtos/luks/assign_whole_disk_role.png
   :width: 100%
   :align: center

The resulting *Role / Wipe / LUKS* page (only bottom half shown):

.. image:: /images/howtos/luks/pre_luks_format_tick.png
   :width: 100%
   :align: center
...
.. image:: /images/howtos/luks/post_luks_tick_password.png
   :width: 100%
   :align: center
...
.. image:: /images/howtos/luks/luks_container_icon.png
   :width: 100%
   :align: center
...
convenience:
   ...
   **Auto unlock via keyfile (Recommended)** Unlock on every boot by using a
   keyfile on the system drive. Unless Rockstor was installed using the
   "Encrypt my data" option the system drive will not be encrypted and so all
   keyfiles will also not be encrypted. This still protects against data
   ...
   '-' are the uuid of the LUKS container and the key is 2048 bytes sourced
   from /dev/urandom (2^14 bit equivalent).
...
.. image:: /images/howtos/luks/luks_boot_up_config_page.png
   :width: 100%
   :align: center
...
.. image:: /images/howtos/luks/luks_auto_unlock_keyfile_create.png
   :width: 100%
   :align: center
...
.. image:: /images/howtos/luks/open_luks_volume.png
   :width: 100%
   :align: center
...
.. image:: /images/howtos/luks/open_luks_volume_info_page.png
   :width: 100%
   :align: center
...
.. image:: /images/howtos/luks/luks_volume_indication_create_pool.png
   :width: 100%
   :align: center
...
.. image:: /images/howtos/luks/luks_volume_indication_pools_page.png
   :width: 100%
   :align: center
...
.. image:: /images/howtos/luks/open_luks_volume_mapped.png
   :width: 100%
   :align: center
