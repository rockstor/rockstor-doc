...
.com/download-server/>`_ page and their `FAQ <https://owncloud.com/faq/>`_.
Take care to select the appropriate documentation version appropriate to your
install as ownCloud is rapidly developing. Rockstor 3.8-2 introduced our
ownCloud Rock-on which on release installed version 8.0.4 of ownCloud. Since
ownCloud is quite a large project there is both a
...
:ref:`rockons_root` that may well already have been made and an additional 1
or 2 shares depending on whether you wish to split your ownCloud config from
its data, this is highly recommended though.

.. image:: /images/interface/docker-based-rock-ons/owncloud_install.png
   :width: 100%
   :align: center
...
.. image:: /images/interface/docker-based-rock-ons/owncloud_shares.png
   :width: 100%
   :align: center
...
.. image:: /images/interface/docker-based-rock-ons/owncloud_port.png
   :width: 100%
   :align: center
...
.. image:: /images/interface/docker-based-rock-ons/owncloud_db.png
   :width: 100%
   :align: center
...
.. image:: /images/interface/docker-based-rock-ons/owncloud_verify.png
   :width: 100%
   :align: center
...
.. image:: /images/interface/docker-based-rock-ons/owncloud_installing.png
   :width: 100%
   :align: center
...
.. image:: /images/interface/docker-based-rock-ons/owncloud_on.png
   :width: 100%
   :align: center

N.B. Notice the **OwnCloud UI** button and the **spanner** to adjust the
Rock-on settings.

Also note that we have an **i icon** and it informs us that:-

.. image:: /images/interface/docker-based-rock-ons/owncloud_info.png
   :width: 100%
   :align: center
...
.. image:: /images/interface/docker-based-rock-ons/owncloud_ui.png
   :width: 100%
   :align: center
